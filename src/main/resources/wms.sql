...
-- Records of client
-- ----------------------------
INSERT INTO `client` VALUES ('1', '小码哥Java学院', 'XMG_JAVA', '123');
...
-- Records of depot
-- ----------------------------
INSERT INTO `depot` VALUES ('1', '天河区', '天河区1号仓');
INSERT INTO `depot` VALUES ('2', '白云区', '白云区2号仓');
...
INSERT INTO `orderbill` VALUES ('4', '004', '2016-02-05 00:00:00', '0', '1116500.00', '600.00', null, '2016-08-19 21:07:24', '7', null, '1');
...
INSERT INTO `permission` VALUES ('73', 'Cat删除', 'com._520it.wms.web.action.CatAction:delete');
INSERT INTO `permission` VALUES ('74', 'Cat列表', 'com._520it.wms.web.action.CatAction:execute');
INSERT INTO `permission` VALUES ('75', 'Cat编辑', 'com._520it.wms.web.action.CatAction:input');
INSERT INTO `permission` VALUES ('76', 'Cat保存/更新', 'com._520it.wms.web.action.CatAction:saveOrUpdate');
...
CREATE TABLE `productstock` (
  ...
  PRIMARY KEY (`id`),
  KEY `FK_87p7m332mco2eax7sofk0jcpi` (`product_id`),
  KEY `FK_peq6y30kbpvs8yc5odojmjuaq` (`depot_id`),
  CONSTRAINT `FK_87p7m332mco2eax7sofk0jcpi` FOREIGN KEY (`product_id`) REFERENCES `product` (`id`),
  CONSTRAINT `FK_peq6y30kbpvs8yc5odojmjuaq` FOREIGN KEY (`depot_id`) REFERENCES `depot` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=18 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of productstock
-- ----------------------------
INSERT INTO `productstock` VALUES ('1', '17800.00', '200.00', '89.00', '1', '1');
INSERT INTO `productstock` VALUES ('2', '30000.00', '300.00', '100.00', '2', '1');
INSERT INTO `productstock` VALUES ('3', '8000.00', '800.00', '10.00', '3', '1');
INSERT INTO `productstock` VALUES ('4', '6000.00', '600.00', '10.00', '5', '1');
INSERT INTO `productstock` VALUES ('5', '24000.00', '200.00', '120.00', '1', '2');
INSERT INTO `productstock` VALUES ('6', '36000.00', '300.00', '120.00', '2', '2');
INSERT INTO `productstock` VALUES ('7', '240000.00', '2000.00', '120.00', '4', '2');
INSERT INTO `productstock` VALUES ('8', '72000.00', '600.00', '120.00', '5', '2');
INSERT INTO `productstock` VALUES ('9', '72000.00', '600.00', '120.00', '6', '2');
INSERT INTO `productstock` VALUES ('10', '96000.00', '800.00', '120.00', '8', '2');
INSERT INTO `productstock` VALUES ('11', '240000.00', '2000.00', '120.00', '11', '2');
INSERT INTO `productstock` VALUES ('12', '42000.00', '350.00', '120.00', '14', '2');
INSERT INTO `productstock` VALUES ('13', '600000.00', '5000.00', '120.00', '9', '2');
INSERT INTO `productstock` VALUES ('14', '300000.00', '2500.00', '120.00', '19', '2');
INSERT INTO `productstock` VALUES ('15', '24000.00', '200.00', '120.00', '16', '2');
INSERT INTO `productstock` VALUES ('16', '60000.00', '500.00', '120.00', '13', '2');
INSERT INTO `productstock` VALUES ('17', '9600.00', '80.00', '120.00', '12', '2');
...
CREATE TABLE `saleaccount` (
  ...
  `product_id` bigint(20) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `FK_6yj4uj637jrhdup0k2lka3q9f` (`saleman_id`),
  KEY `FK_pqeslof7yhsmnwv9j34stku4o` (`client_id`),
  KEY `FK_4eia6d6ccb1slt1kqfxn22aan` (`product_id`),
  CONSTRAINT `FK_4eia6d6ccb1slt1kqfxn22aan` FOREIGN KEY (`product_id`) REFERENCES `product` (`id`),
  CONSTRAINT `FK_6yj4uj637jrhdup0k2lka3q9f` FOREIGN KEY (`saleman_id`) REFERENCES `employee` (`id`),
  CONSTRAINT `FK_pqeslof7yhsmnwv9j34stku4o` FOREIGN KEY (`client_id`) REFERENCES `client` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of saleaccount
-- ----------------------------
INSERT INTO `saleaccount` VALUES ('1', '2017-11-06 12:26:53', '4000.00', '200.00', '20.00', '8000.00', '400.00', '1', '1', '1');
INSERT INTO `saleaccount` VALUES ('2', '2017-11-06 12:26:53', '6000.00', '300.00', '20.00', '10000.00', '500.00', '1', '1', '2');
...
INSERT INTO `stockincomebill` VALUES ('4', '004', '2016-06-20 00:00:00', '1', '907800.00', '780.00', '2017-11-06 12:17:17', '2016-08-19 21:27:28', '19', '1', '2');
...
INSERT INTO `stockincomebill` VALUES ('6', '001', '2017-11-01 00:00:00', '1', '10000.00', '40.00', '2017-11-06 12:25:52', '2017-11-06 12:25:45', '1', '1', '1');
...
INSERT INTO `stockincomebillitem` VALUES ('78', '200.00', '20.00', '4000.00', '', '1', '6');
INSERT INTO `stockincomebillitem` VALUES ('79', '300.00', '20.00', '6000.00', '', '2', '6');
...
INSERT INTO `stockoutcomebill` VALUES ('6', '001', '2017-11-01 00:00:00', '1', '18000.00', '40.00', '2017-11-06 12:26:53', '2017-11-06 12:26:33', '1', '1', '1', '1');
...
INSERT INTO `stockoutcomebillitem` VALUES ('41', '400.00', '20.00', '8000.00', '', '1', '6');
INSERT INTO `stockoutcomebillitem` VALUES ('42', '500.00', '20.00', '10000.00', '', '2', '6');
...
-- ----------------------------
INSERT INTO `systemmenu` VALUES ('1', '系统模块', '', 'systemManage', null);
