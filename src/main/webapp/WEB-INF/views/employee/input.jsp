        ...
        <div class="ui_content">
            <table cellspacing="0" cellpadding="0" width="100%" align="left" border="0">
                ...
                <tr>
                    ...
                    <td class="ui_text_lt">
                        <s:select list="#depts" name="employee.dept.id" cssClass="ui_select01" listKey="id" listValue="name"/>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class="ui_text_lt">
                        <table>
                            <tr>
                                <td>
                                    <s:select list="#roles" listKey="id" listValue="name" class="ui_multiselect01 all_permissions"
                                              multiple="true"/>
                                </td>
                                <td align="center">
