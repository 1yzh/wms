                    ...
                    <s:iterator value="#pageResult.listData">
                        <tr>
                            ...
                            <td>
                                ...
                                <a class="example_group" href="<s:property value="imagePath"/>" title="<s:property value="name"/>">
                            ...
                            <td>
                                <s:a namespace="/" action="product_input">
                                    <s:param name="product.id" value="id"/>编辑
                                </s:a>
                                <s:url namespace="/" action="product_delete" var="url">
