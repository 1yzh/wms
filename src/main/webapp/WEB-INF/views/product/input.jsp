...
<s:form name="editForm" namespace="/" action="product_saveOrUpdate" method="post" id="editForm" enctype="multipart/form-data">
    ...
    <div id="container">
        <div id="nav_links">
            <span style="color: #1A5CC6;">产品编辑</span>
            <div id="page_close">
                <a>
        ...
        <div class="ui_content">
            <table cellspacing="0" cellpadding="0" width="100%" align="left" border="0">
                <tr>
                    <td class="ui_text_rt" width="140">产品名称</td>
                    <td class="ui_text_lt">
                        <s:textfield name="product.name" cssClass="ui_input_txt02"/>
                    </td>
                </tr>
                <tr>
                    <td class="ui_text_rt" width="140">产品编码</td>
                    <td class="ui_text_lt">
                        <s:textfield name="product.sn" cssClass="ui_input_txt02"/>
                    </td>
                </tr>
                <tr>
                    <td class="ui_text_rt" width="140">产品品牌</td>
                    <td class="ui_text_lt">
                        <s:select name="product.brand.id" list="#brands" cssClass="ui_select03" listKey="id" listValue="name"/>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <s:if test="product.id != null">
                        <%--product.smallImagePath 此处需要使用domain/paoduct类里的get方法--%>
                        <img src=<s:property value="product.smallImagePath"/> width=80 >
                    </s:if>
                    </td>
                </tr>
                <tr>
                    <td class="ui_text_rt" width="140">产品介绍</td>
                    <td class="ui_text_lt">
